...
ALTER TABLE REPUESTOS DROP COLUMN img_repu;
ALTER TABLE REPUESTOS MODIFY COLUMN stock SMALLINT NOT NULL DEFAULT 0;
...
CREATE TABLE KARDEX(
	...
	CONSTRAINT fk_idc_kar FOREIGN KEY (idcompra) REFERENCES COMPRAS (idcompra),
