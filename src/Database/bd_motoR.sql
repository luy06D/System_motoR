...
ALTER TABLE ORDEN_COMPRAS ADD CONSTRAINT uk_num_or UNIQUE(num_ordenC);
ALTER TABLE ORDEN_COMPRAS ADD COLUMN subtotal DECIMAL(6,2) NOT NULL;
...
CREATE TABLE DETALLE_ORDENC(
    ...
    subtotal				DECIMAL(6,2) NOT NULL, -- ESTE CAMPO FUE ELIMINADO 
...
ALTER TABLE DETALLE_ORDENC DROP COLUMN subtotal;
